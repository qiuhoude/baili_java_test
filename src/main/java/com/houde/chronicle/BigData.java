...
public class BigData {
    final static long MAXSIZE = 1000L;
    ...
    static {
        // averageValue()/.constantValueSizeBySample()/.averageValueSize()
        builder.actualSegments(1 * 1024)
                .averageValue(new BigDataStuff(100 * 1000L))
                .entries(MAXSIZE);
