...
public class UDPServer {
        ...
        try {
            ...
            for (;;) {
                ...
                if (!sendMessage132.equals("") && !sendMessage129.equals("")) {
                    send(sendMessage129, port132, address132, server);
                    send(sendMessage132, port129, address129, server);
                    sendMessage132 = "";
                    sendMessage129 = "";
                }
            }
    ...
    private static void send(String sendMessage132, int port132, InetAddress address132, DatagramSocket server) {
        try {
