...
public class RBTree<T extends Comparable<T>> {
    ...
    /**
     * add value to a new node,if this value exist in this tree, if value exist,it will return the exist value.otherwise
     * return null if override mode is true,if value exist in the tree, it will override the old value in the tree
     *
     * @param value
     * @return
     */
    ...
    /**
     * find the value by give value(include key,key used for search, other field is not used,@see compare method).if
     * this value not exist return null
     * 
     * @param value
     * @return
     */
        ...
        while (dataRoot != null) {
            ...
            if (cmp < 0) {
                ...
                if (dataRoot.getRight() != null) {
                    RBTreeNode<T> min = removeMin(dataRoot.getRight());// 找自己右子中最小的
 ...
 */
    ...
    private void fixInsert(RBTreeNode<T> x) {
         ...
         *
         * 解决: 1.父和叔变都变黑, 2.祖父变红, 3.新增节点指向祖父节点
         *
         * ● 插入修复情况2：当前节点的父节点是红色,叔叔节点是黑色，当前节点是其父节点的右子
         *
         * 解决: 1.新增节指向父节点, 2.左旋服当前新增(父节点)节点
         *
         * ● 插入修复情况3：当前节点的父节点是红色,叔叔节点是黑色，当前节点是其父节点的左子
         *
         * 解决: 1.父变黑 2.祖父变红 3.右旋祖父节点
         */
...
LeftRoate(T, x)
    ...
    x.p ← y
        ...
        左旋: 1. 将自己的右子取代自己的位置 2. 将自己右子的位置指向右子的左子


        右旋: 1. 将自己的左子取代自己的位置 2. 将自己左子的位置指向左子的右子
