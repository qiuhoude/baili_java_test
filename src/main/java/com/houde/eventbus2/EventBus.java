...
import com.houde.eventbus2.util.EventBusException;
import com.houde.eventbus2.util.SubscriberMethodFinder;
...
//            postToSubscription(newSubscription, stickyEvent, Looper.getMainLooper() == Looper.myLooper());
    ...
    public synchronized void unRegister(Object subscriber) {
        ...
        if (subscribedTypes != null) {
            ...
            System.err.println("Subscriber to unregister was not registered before: " + subscriber.getClass());
        }
    }
